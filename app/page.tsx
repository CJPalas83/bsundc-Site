            ...
            >
              ...
              <motion.div variants={fadeUp}>
                <Link
                  ...
                  className="group block bg-bg-main border-2 border-accent/40 hover:border-accent p-5 md:p-6 transition-colors duration-200"
                >
              ...
              <motion.div variants={fadeUp}>
                <Link
                  ...
                  className="group block bg-bg-main border border-text-main/15 hover:border-accent/50 p-4 transition-colors duration-200"
                >
                  <div className="flex items-baseline justify-between mb-2 gap-4">
